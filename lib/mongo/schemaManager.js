...
module.exports = function(schemaConverter, schemaValidator)
{
    ...
    schemaManager.loadAllSchemas = function(paths)
    {
        ...
        for(var type in allSchema)
        {
            ...
            var processedSchema = schemaValidator.getFullSchema(type, allSchema[type]);
    ...
    schemaManager.asyncValidateAndSaveObjects = function(type, widToObjects, metaInformation)
    {
